...
**Import / Export overhaul (backup format v2)**
* **Offline restore** — exports now archive every script's cached
  `@require` / `@resource` / `@icon` files; importing pre-seeds those exact
